...
Following code snippet shows a function _FindMax_ that takes two integer values and returns the larger of the two. It has public access specifier, so it can be accessed from outside the class using an instance of the class.
